...
export class AppMenuComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        this.model = [
            {label: 'Inicio', routerLink: ['/' + Constantes.ROUTE_INICIO], visible: true},
            {label: 'Showcase', routerLink: ['/' + Constantes.ROUTE_SHOWCASE], visible: true},
            {
                label: 'Gestionar Usuarios', routerLink: ['/' + Constantes.ROUTE_GESTIONAR_USUARIOS],
                visible: this.authService.tienePerfil(Constantes.ID_PERFIL_ADMINISTRADOR)
            },
            {
...
export class AppSubMenuComponent {
    ...
    constructor(public appTemplate: AppTemplateComponent, public appMenu: AppMenuComponent) {
    }
